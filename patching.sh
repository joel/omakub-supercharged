...
cp -r ~/.local/share/omakub-supercharged/src/install/desktop/optional $OMAKUB_DIRECTORY/install/desktop/optional
...
cp ~/.local/share/omakub-supercharged/src/bin/omakub-sub/migrate.sh $OMAKUB_DIRECTORY/bin/omakub-sub/migrate.sh
